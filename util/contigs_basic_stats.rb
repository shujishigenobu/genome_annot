...
FlatFile.open(FastaFormat, ARGV[0]).each do |fa|
  fastas << fa
end
...
%w{num_contigs shortest longest mean median N50 N90 total_bases total_bases_atgc total_bases_Ns }.each do |k|
